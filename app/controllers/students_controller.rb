class StudentsController < ApplicationController
    ...
    def student_options
      [
        ...
        'student_weekly_progresses.registered_mentor_sessions', 
        'student_weekly_progresses.week', 
        'student_weekly_progresses.registered_mentor_sessions.mentor_course', 
        'student_weekly_progresses.registered_mentor_sessions.mentor_course.mentor', 
        'student_weekly_progresses.registered_mentor_sessions.mentor_course.mentor.user', 
        'student_weekly_progresses.week.course', 
        'student_weekly_progresses.week.unit', 
        'student_weekly_progresses.week.lesson'
      ]
    end
